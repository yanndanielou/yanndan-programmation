...
@CALL :INSTALL_INTERNAL_PYTHON_LIB Rhapsody
@CALL :INSTALL_INTERNAL_PYTHON_LIB Game
@CALL :INSTALL_INTERNAL_PYTHON_LIB ExampleLibrary
@CALL :INSTALL_INTERNAL_PYTHON_LIB ChampFX
@REM @CALL :INSTALL_INTERNAL_PYTHON_LIB ShutTheBox
