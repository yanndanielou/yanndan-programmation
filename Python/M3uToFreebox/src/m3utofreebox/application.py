...
class M3uToFreeboxApplication:
    ...
    def download_file_blocking_without_progress(
        self, file_destination_full_path: str, m3u_entry: m3u.M3uEntry, filename: str
    ) -> None:
    ...
    def download_movie_file_by_id(self, destination_directory: str, m3u_entry_id: int) -> None:
        ...
        if m3u_entry.can_be_downloaded():
            ...
            with open(file_destination_full_path, "wb") as f:
                ...
                self.download_file_blocking_without_progress(
                    file_destination_full_path, m3u_entry, file_destination_full_path
                )
