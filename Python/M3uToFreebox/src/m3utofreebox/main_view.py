...
class M3uToFreeboxMainView(tkinter.Tk):
    ...
    def _create_menu(self) -> None:
        ...
        menu_bar.config(font=("Courier", 11), bg=menu_bg, fg=menu_fg, borderwidth=6, relief=tkinter.RAISED)

        file_menu = tkinter.Menu(menu_bar, tearoff=0, font=("Courier New", 10), bg=submenu_bg, fg=submenu_fg)
    ...
    def menu_open_last_m3u_file_loaded(self) -> None:
    ...
    def menu_select_and_open_file(self) -> None:
        """Select and open new file"""
    ...
    @property
    def m3u_to_freebox_application(self) -> "M3uToFreeboxApplication|None":
