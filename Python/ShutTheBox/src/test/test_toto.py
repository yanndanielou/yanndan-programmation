...
class TestCombinaisons:
    ...
    class TestTwoDices:
        ...
        def test_get_two_dices_all_combinaisons_with_occurences(self)->None:
            """ Number of results """
            two_dices_all_combinaisons_with_occurences:dict[int,list[Tuple[int, int]]] = shutthebox.dices.Dices.get_two_dices_all_combinations_by_sum()
    ...
    class TestThreeDices:
        ...
        def test_get_several_dices_all_combinaisons_by_sum(self)->None:
            """ Number of results """
            dices_all_combinaisons_with_occurences:dict[int,list[Tuple[int, ...]]] = shutthebox.dices.Dices.get_several_dices_all_combinations_by_sum(self.number_of_dices)
