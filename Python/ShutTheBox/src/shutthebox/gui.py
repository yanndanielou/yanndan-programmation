...
class TreeViewApp:
    ...
    def populate_tree(self, situation: "Situation", parent: str = "") -> None:
        ...
        situation_id = self.tree.insert(
            parent,
            "end",
            text=f"Situation: Opened Hatches {situation.opened_hatches} , final odds to happen {situation.get_odds_to_happen_from_initial_situation_taking_into_account_dices_and_hatches()* 100:.2f}%",
        )
