...
def get_classic_archive_library_base_builder(archive_decoder: decode_archive.ArchiveDecoder) -> decode_archive.ArchiveLibrary.Builder:
    archive_library_builder = (
    ...
    return archive_library_builder
