...
class OneEquipmentReport:
    ...
    def __post_init__(self) -> None:
        ...
        self.mediane = relevant_values_sorted_by_value[n // 2] if n % 2 != 0 else (relevant_values_sorted_by_value[n // 2 - 1] + relevant_values_sorted_by_value[n // 2]) / 2
        ...
        points_saturation = sum(1 for x in self.all_relevant_values if x >= 98)
        self.taux_saturation = (points_saturation / len(self.all_relevant_values)) * 100
        ...
        self.taux_anomalie_high = (len(self.anomalies_very_high) / len(self.all_relevant_values)) * 100
