...
@pytest.fixture(scope="session", name="next_line_without_dc_log_fixture")
def next_line_without_dc_log() -> line_topology.Line:
...
@pytest.fixture(scope="session", name="next_line_with_dc_log_fixture")
def next_line_with_dc_log() -> line_topology.Line:
    line = line_topology.Line.load_from_csv(
        segments_csv_full_path=r"D:\NEXT\Data\Csv\NEXT_segment.csv",
        track_circuits_csv_full_path=r"D:\NEXT\Data\Csv\NEXT_track_circuit.csv",
        tracking_blocks_csv_full_path=r"D:\NEXT\Data\Csv\NEXT_tracking_block.csv",
        ...
        segments_relations_csv_full_path=r"D:\NEXTTS\Data\Csv\NEXT_tsSegmentRelation.csv",
        tracking_block_on_segments_csv_full_path=r"D:\NEXTTS\Data\Csv\NEXT_tsLocUnitTopo.csv",
        virtual_canton_csv_full_path=r"C:\D\temp\NEXT_INV_V6_16_P2_conf\conf\dc_log\dc_cv.csv",
        virtual_canton_extremities_csv_full_path=r"C:\D\temp\NEXT_INV_V6_16_P2_conf\conf\dc_log\dc_ext_cv.csv",
        ignore_tracking_blocks_without_circuits=True,
    )
    logger_config.print_and_log_info("next_line_fixture is ready!")
    return cast("line_topology.Line", line)
...
class TestNextDataWithDcLog:
    def test_tracking_blocks_are_created(self, next_line_with_dc_log_fixture: line_topology.Line) -> None:
        line = next_line_with_dc_log_fixture
        assert line.tracking_blocks

    def test_virtual_cantons_are_created(self, next_line_with_dc_log_fixture: line_topology.Line) -> None:
        assert next_line_with_dc_log_fixture.virtual_canton_by_id
        assert next_line_with_dc_log_fixture.virtual_cantons

    def test_tracking_blocks_ignored(self, next_line_with_dc_log_fixture: line_topology.Line) -> None:
        line = next_line_with_dc_log_fixture
    ...
    def test_segments_relations(self, next_line_with_dc_log_fixture: line_topology.Line) -> None:
        line = next_line_with_dc_log_fixture
...
class TestNextDataWithoutDcLog:
    def test_tracking_blocks_are_created(self, next_line_without_dc_log_fixture: line_topology.Line) -> None:
        line = next_line_without_dc_log_fixture
        assert line.tracking_blocks

    def test_tracking_blocks_ignored(self, next_line_without_dc_log_fixture: line_topology.Line) -> None:
        line = next_line_without_dc_log_fixture
        assert line.not_created_tracking_blocks_ids_without_track_circuits
        assert len(line.not_created_tracking_blocks_ids_without_track_circuits) < len(line.tracking_blocks)
        for not_created_tracking_blocks_id_without_track_circuit in line.not_created_tracking_blocks_ids_without_track_circuits:
    ...
    def test_segments_relations(self, next_line_without_dc_log_fixture: line_topology.Line) -> None:
        line = next_line_without_dc_log_fixture
        segment_8329 = line.segment_by_number[8329]
        assert segment_8329
        assert segment_8329 is not None
    ...
    class TestDistances:
        ...
        class TestSegmentsExtremities:
            ...
            class TestSegmentExtremities0ToLength:
                def test_increasing(self, next_line_without_dc_log_fixture: line_topology.Line) -> None:
                    line = next_line_without_dc_log_fixture
                ...
                def test_decreasing(self, next_line_without_dc_log_fixture: line_topology.Line) -> None:
                    line = next_line_without_dc_log_fixture
                    seg1 = line.get_segment("SEG_010812")
                    assert (
        ...
        def test_segments_distances(self, next_line_without_dc_log_fixture: line_topology.Line) -> None:
            line = next_line_without_dc_log_fixture
            seg1 = line.get_segment("SEG_010812")
            seg1 = line.get_segment("SEG_010812")
