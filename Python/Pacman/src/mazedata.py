...
class MazeBase:
    def __init__(
        ...
        self.ghost_node_deny = ghost_node_deny
        self.name = name
...
class Maze1(MazeBase):
    def __init__(self) -> None:
        super().__init__(
            name="maze1",
            ghost_node_deny={constants.UP: ((12, 14), (15, 14), (12, 26), (15, 26))},
        ...
        # self.ghost_node_deny = {constants.UP: ((12, 14), (15, 14), (12, 26), (15, 26)), constants.LEFT: (self.addOffset(2, 3),), constants.RIGHT: (self.addOffset(2, 3),)}
        self.ghost_node_deny[constants.LEFT] = (self.addOffset(2, 3),)
        self.ghost_node_deny[constants.RIGHT] = (self.addOffset(2, 3),)
