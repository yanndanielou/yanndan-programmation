...
if __name__ == "__main__":
    with logger_config.application_logger("nombres_et_syllabes"):
        ...
        modes: List[ModexFrame] = [
            ...
            AdditionExercise(game_main_window, first_number=random.randint(0, 10), second_number=random.randint(2, 8)),
            SoustractionExercise(game_main_window, first_number=random.randint(3, 9), second_number=random.randint(2, 3)),
            AdditionExercise(game_main_window, first_number=random.randint(0, 20), second_number=random.randint(3, 10)),
