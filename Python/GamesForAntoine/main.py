...
if __name__ == "__main__":
    with logger_config.application_logger("nombres_et_syllabes"):
        ...
        modes: List[ModexFrame] = [
            ...
            AdditionExercise(game_main_window, switch_mode_callback=game_main_window.switch_mode, first_number=random.randint(0, 20), second_number=random.randint(2, 10)),
            ...
            AdditionExercise(game_main_window, switch_mode_callback=game_main_window.switch_mode, first_number=random.randint(3, 9), second_number=random.randint(2, 5)),
            ...
            SoustractionExercise(game_main_window, switch_mode_callback=game_main_window.switch_mode, first_number=random.randint(3, 9), second_number=random.randint(2, 3)),
