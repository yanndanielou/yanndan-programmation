...
class MazeGame:
    def __init__(self, root: tk.Tk, size: int = 14) -> None:
        self.size = size
        self.root = root
    ...
    def _generate_path(self, maze: List[Tuple[int, int]], solution_path: List[Tuple[int, int]], x: int, y: int) -> List[Tuple[int, int]]:
