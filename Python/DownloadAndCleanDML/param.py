...
DML_FILE_CONVERTED_TO_STANDARD_XSLX_PATH = f"{DEFAULT_DOWNLOAD_DIRECTORY}\\DML_NEXTEO_ATS+_V14_standard_excel.xlsx"
DML_FILE_WITH_USELESS_RANGES_PATH = f"{DEFAULT_DOWNLOAD_DIRECTORY}\\DML_NEXTEO_ATS+_V14_with_useless_ranges_cleaned.xlsm"
DML_FILE_WITH_USELESS_COLUMNS_REMOVED_XLWINGS_PATH = f"{DEFAULT_DOWNLOAD_DIRECTORY}\\DML_NEXTEO_ATS+_V14_with_useless_columns_removed_xlwings.xlsm"
DML_FILE_WITH_USELESS_COLUMNS_REMOVED_OPENPYXL_PATH = f"{DEFAULT_DOWNLOAD_DIRECTORY}\\DML_NEXTEO_ATS+_V14_with_useless_columns_removed_openpyxl.xlsm"
DML_FILE_WITHOUT_LINKS_PATH = f"{DEFAULT_DOWNLOAD_DIRECTORY}\\DML_NEXTEO_ATS+_V14_without_links.xlsm"
DML_FILE_CLEANED_FINAL_PATH = f"{DEFAULT_DOWNLOAD_DIRECTORY}\\DML_NEXTEO_ATS+_V14_cleaned_light.xlsm"
