...
class TestSudokuConstruction:
    ...
    def test_few_regions(self) -> None:
        ...
        assert region.get_all_cells_ordered_from_top_left()[0].x == 3
        assert region.get_all_cells_ordered_from_top_left()[0].y == 0

        region = game_board.get_region_by_x_and_y(0, 1)
        assert region.get_all_cells_ordered_from_top_left()[0].x == 0
        assert region.get_all_cells_ordered_from_top_left()[0].y == 3
