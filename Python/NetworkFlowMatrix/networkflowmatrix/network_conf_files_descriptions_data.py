...
class BordAdressPlanV9Description:
    def __init__(self) -> None:
        ...
        self.ip_tu_tab: EquipmentDefinitionTab = EquipmentDefinitionTab(
            tab_name="@IP TU",
            rows_to_ignore=[0, 1, 2, 3, 4, 6],
            equipment_ip_definitions=[UnicastIpDefinitionColumnsInTab(equipment_ip_address_column_definition=ExcelColumnDefinitionByColumnTitle("CPL SUBNET_1"))],
        )
        self.ip_reseau_std_tab: EquipmentDefinitionTab = EquipmentDefinitionTab(
            tab_name="IP RESEAU STD",
            rows_to_ignore=[0, 1, 2, 3, 4, 6, 7],
