...
from typing import Dict, List, Optional, Set, Tuple, cast, TYPE_CHECKING
...
if TYPE_CHECKING:
    from networkflowmatrix import equipments, network_entity_provider, network_matrix_data_model
