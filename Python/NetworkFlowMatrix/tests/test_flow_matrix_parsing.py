...
from networkflowmatrix.network_matrix_data_model import (
    NetworkFlowMatrix,
)


@pytest.fixture(scope="session", name="parse_flow_matrix_file_v15_and_build_objects_fixture")
...
class TestNoErrorAtBUild:
    def test_parse_flow_matrix_file_and_build_objects(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        assert parse_flow_matrix_file_v15_and_build_objects_fixture
        assert parse_flow_matrix_file_v15_and_build_objects_fixture.network_flow_matrix_lines


class TestEquipmentAndSubystemCreationOnTheFlowOfFlowMatrixParsing:
    def test_all_subsystem_names_are_unique(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
    ...
    def test_all_equipment_names_are_unique(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
        assert network_flow_matrix
    ...
    def test_all_subsystem_names_trimmed(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
        assert network_flow_matrix
        for subsystem in network_flow_matrix.all_matrix_flow_subsystems_definitions_instances:
            assert subsystem.name == subsystem.name.strip()

    def test_all_equipment_names_trimmed(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
        assert network_flow_matrix
        for equipment in network_flow_matrix.all_matrix_flow_equipments_definitions_instances:
            assert equipment.name == equipment.name.strip()

    def test_all_equipment_names_capital_letter_to_ensure_uniqueness(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
        assert network_flow_matrix
        for equipment in network_flow_matrix.all_matrix_flow_equipments_definitions_instances:
            assert equipment.name == equipment.name.upper()

    def test_all_subsystem_names_capital_letter_to_ensure_uniqueness(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
        assert network_flow_matrix
        for subsystem in network_flow_matrix.all_matrix_flow_subsystems_definitions_instances:
            assert subsystem.name == subsystem.name.upper()

    def test_all_equipments_have_name(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
        assert network_flow_matrix
        for equipment in network_flow_matrix.all_matrix_flow_equipments_definitions_instances:
    ...
    def test_existance_of_equipment_with_several_susbystems(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
    ...
    def test_all_equipments_of_each_subsystem_has_the_subsystem(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
        for subsystem in network_flow_matrix.all_matrix_flow_subsystems_definitions_instances:
    ...
    def test_all_subsystem_of_each_equipment_has_the_equipment(self, parse_flow_matrix_file_v15_and_build_objects_fixture: NetworkFlowMatrix) -> None:
        network_flow_matrix = parse_flow_matrix_file_v15_and_build_objects_fixture
        for equipment in network_flow_matrix.all_matrix_flow_equipments_definitions_instances:
