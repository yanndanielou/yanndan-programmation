...
class TestConstantIntervalDatesGenerator:
    ...
    def test_with_one_day_interval(self) -> None:
        ...
        all_dates = dates_generator._compute_dates_since_until_now(datetime(year=2025, month=7, day=1))
        assert all_dates
    ...
    def test_with_no_interval(self) -> None:
        ...
        with pytest.raises(AssertionError):
            dates_generator._compute_dates_since_until_now(datetime(year=2025, month=7, day=1))
